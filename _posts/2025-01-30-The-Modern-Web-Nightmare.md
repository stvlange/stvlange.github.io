...
<aside>{% include figure.liquid loading="eager" path="assets/img/gopher.png" class="img-fluid rounded z-depth-1" zoomable=true %}<p>The Gopher text based experience.</p></aside>
